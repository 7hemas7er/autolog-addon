...
(function (root, factory) {
  ...
  var DICT = {
    it: {
      ...
      'mqtt.title': 'Sensori Home Assistant',
      'mqtt.connected': 'Connesso al broker {target}: i sensori sono pubblicati.',
      'mqtt.disconnected': 'Broker {target} non raggiungibile. I sensori restano all\'ultimo valore finché la connessione non torna; l\'app funziona lo stesso.',
      'mqtt.unavailable': 'Nessun broker MQTT disponibile, quindi i sensori in Home Assistant non vengono creati. Installa l\'add-on Mosquitto, oppure indica un broker nelle opzioni dell\'add-on.',
      'mqtt.disabled': 'Pubblicazione MQTT disattivata nelle opzioni: l\'app funziona, ma non crea sensori in Home Assistant.',
    ...
    en: {
      ...
      'mqtt.title': 'Home Assistant sensors',
      'mqtt.connected': 'Connected to broker {target}: the sensors are being published.',
      'mqtt.disconnected': 'Broker {target} unreachable. The sensors hold their last value until it comes back; the app itself keeps working.',
      'mqtt.unavailable': 'No MQTT broker available, so no sensors are created in Home Assistant. Install the Mosquitto add-on, or point the add-on options at a broker.',
      'mqtt.disabled': 'MQTT publishing is turned off in the options: the app works, but creates no sensors in Home Assistant.',
      'data.units': 'Units',
